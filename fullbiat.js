	...
	function iatExtension(options)
	{
		...
		var batObj = 
		{
			...
			instTemplate: '<div><p align="center" style="font-size:20px; font-family:arial"><br/>' +
				...
				'Press the <b>E</b> key<font color="#FFFFFF">__________________________________<font color="#000000">Press the <b>I</b> key<br/>' +
				'if the item is <b>not</b> a<font color="#FFFFFF">_______________________________________<font color="#000000">if the item <b>is</b> a<br/>' +
				'Truthteller or a Truth item.<font color="#FFFFFF">_______________<font color="#000000">Truthteller or Truth item.<br/><br/>' +
